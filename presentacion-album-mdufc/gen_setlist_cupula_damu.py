#!/usr/bin/env python3
"""Generate setlist_cupula_damu.pdf — marcadores del proyecto para Damu (batería).

La Cúpula 26/09/2026, mismos temas que Niceto 23/08/2026 (show con Renacer Del
Tiempo). Tinta invertida (fondo blanco) para gastar menos tinta.
"""
...
OUT  = ROOT / "setlist_cupula_damu.pdf"
